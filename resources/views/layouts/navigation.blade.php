    ...
    <nav class="flex-1 px-4 py-6 overflow-y-auto">
        <ul class="space-y-2">
            @if(auth()->user()->role === 'admin')
                ...
                <li>
                    <a href="{{ route('admin.bookings') }}" class="block px-4 py-2 rounded hover:bg-gray-200 {{ request()->routeIs('admin.bookings') ? 'bg-gray-200 font-bold' : '' }}">
                        View Bookings
                    </a>
                </li>
            @elseif(auth()->user()->role === 'supplier')
                ...
                <li>
                    <a href="{{ route('supplier.bookings.index') }}" class="block px-4 py-2 rounded hover:bg-gray-200 {{ request()->routeIs('supplier.bookings.*') ? 'bg-gray-200 font-bold' : '' }}">
                        My Bookings
                    </a>
                </li>
